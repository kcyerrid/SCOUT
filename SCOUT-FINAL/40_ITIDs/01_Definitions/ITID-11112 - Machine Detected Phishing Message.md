...
entity_type: itid
itid_id: ITID-11112
itid_name: Machine Detected Phishing Message
itid_category:
  - human
  - company_brand
  - device
...
itid_children: []
definition: ITID-11112 is designed to capture all instances of a non-human actor (i.e. computer) reporting a phishing message to security.  Unlike human-based detections, a machine-detected phish has a higher probability of being a true positive.
scope_includes:
...
typical_indicators:
  - Incident detected on email security appliance
  - Incident reported into the SIEM directly
