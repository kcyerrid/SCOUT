...
journal_start_date: 2026-01-25
journal_end_date: 2026-01-31
...
>```dataviewjs
>const start = dv.date("2026-01-25");
>const end = dv.date("2026-01-31");
...
>  AND file.day >= date("2026-01-25")
>  AND file.day <= date("2026-01-31")
>  SORT file.day ASC
