...
The core engine behind SCOUT is Obsidian, which is supported on Windows, MacOS, and Linux.  
...
1. Open your browser and go to [Download Obsidian](https://www.obsidian.md/download).
...
You can optionally download the APK for Android from the [Download Obsidian](https://www.obsidian.md/download) page.
